...
const HERO_IMAGE_URL: string =
  "https://res.cloudinary.com/dquki4xol/image/upload/f_auto,q_auto/v1783589975/036e141dd16a2546ed5671daf82e22b69887d481_mehgi2.png";

export default function WorkshopSection(): JSX.Element {
    ...
    <div className="w-full">
      ...
      <div className="pt-8 text-center">
        <h1 className="text-base font-semibold text-gray-900 sm:text-lg">
          Space Hire for Workshops &amp; Classes
        </h1>
      </div>
