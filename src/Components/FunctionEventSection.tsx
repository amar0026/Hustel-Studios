...
const HERO_IMAGE_URL: string =
  "https://res.cloudinary.com/dquki4xol/image/upload/v1783589975/c07152b7e169ae8ef6933b6ecc18a89cbc82f311_lrm7td.png";
  ...
  return (
    <div className="w-full">
      ...
      <div className="mx-auto max-w-3xl px-6 py-12 md:py-14">
        ...
        >
       Room hire for functions and events in Sydney,<br/>
