...
const HERO_IMAGE_URL: string =
  "https://res.cloudinary.com/dquki4xol/image/upload/v1783426840/b2394ac1baa4b3f0def311630503f983fb36e962_ppo3gn.png";
...
export default function Hero(): JSX.Element {
  ...
  return (
    <section className="relative mx-auto max-w-7xl overflow-visible px-6 pb-24 pt-16 md:pb-28 md:pt-20">
      <div className="relative grid grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-16">
        ...
        <div>
          ...
          <p
            className={`mt-6 max-w-md text-gray-500 transition-all duration-700 ease-out ${
        ...
        >
          <div className="overflow-hidden rounded-[2.5rem] shadow-xl">
            <img
              ...
              className="h-105 w-full object-cover transition-transform duration-700 ease-out hover:scale-105"
            />
          </div>
        </div>
      </div>
      ...
      <div
        className={`absolute bottom-23  z-20 w-[92%] max-w-4xl -translate-x-1/2 transition-all duration-700 ease-out md:left-[37%] md:w-[80%] ${
          mounted
            ? "translate-y-0 opacity-100 md:-translate-x-1/2"
            : "translate-y-4 opacity-0 md:-translate-x-1/2"
        }`}
